  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <!-- Iniciar sesión -->
        <button v-if="!existeUsuario" type="button" class="btn btn-outline-primary mx-2" data-bs-toggle="modal"
          data-bs-target="#login">
          Log in
        </button>
        <!-- Cerrar sesión -->
        <button v-if="existeUsuario" class="btn btn-outline-danger me-2" data-bs-toggle="modal" data-bs-target="#login"
          @click="signout">
          Log out
        </button>
        <!-- Regístrate -->
        <button v-if="!existeUsuario" type="button" class="btn btn-outline-warning" data-bs-toggle="modal"
...
export default {
  ...
  mounted() {
  console.log('existeUsuario:', this.existeUsuario); // Verifica el valor
}
}
</script>
...
.navbar-nav .nav-link {
  ...
  /* Color negro para todos los links */
}

.navbar-nav .nav-link.active {
  color: black !important;
  /* Color negro para el link activo */
}

.navbar-toggler-icon {
  color: black !important;
  /* Cambiar color del ícono de toggler si lo necesitas */
}
</style>
